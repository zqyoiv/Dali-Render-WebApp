...
const ObjectLocationData = {
  ...
  "5": { name: "ShelReal", location: ["M", "RM"] },
  "6": { name: "TreeHole", location: ["B"] },
  "7": { name: "BreadKey", location: ["M"] },
  ...
  "13": { name: "FlowerWoman", location: ["M", "B"] },
  "14": { name: "FlowerInsect2", location: ["M"] },
  "15": { name: "ThumbClock", location: ["M", "B"] },
  "16": { name: "EggEye", location: ["M", "RM"] },
  "17": { name: "BellTower", location: ["B"] },
  "18": { name: "LobsterSaxophone", location: ["M", "RM"] },
  "19": { name: "SpoonChair", location: ["M", "RC"] },
  ...
  "26": { name: "SpoonMoon", location: ["M", "B"] },
